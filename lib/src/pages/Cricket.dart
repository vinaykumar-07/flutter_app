...
class _CricketPageState extends State<CricketPage> {
  ...
  Future<void> _fetchCricketDetails() async {
    String apiUrl =
        'https://apiv2.allsportsapi.com/cricket/?met=Leagues&APIkey=c77a4126fc64f762ba518b7a0179b5cd13d023513d6a39b7f8c636ab43b114c2';
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        for (var client in responseData) {
          ...
          String leagueyear = client['league_year'];
